...
checkpoint_dir = os.environ['FAST'] + "/rpisano1/checkpoints_ft_not_pddl/"
...
# dataset = dataset.filter(lambda x: x['info'] in ["Math-Shepherd", "PRM-1w"])
...
# tokenized_dataset.save_to_disk(f"{data_dir}/tokenized_dataset_not_pddl")

tokenized_dataset = load_from_disk(f"{data_dir}/tokenized_dataset_not_pddl")
